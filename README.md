...
- YouTube 페이지 로딩 중 멈춤을 유발할 수 있던 과도한 DOM 감시/렌더링을 완화
- 페이지 오른쪽 아래 고정 패널 제거
...
1. `cliptap-v1.1.1-chrome.zip` 압축 풀기
...
```bash
git commit -m "Fix YouTube page freeze in ClipTap"
```
